...
let kGreenColor = UIColor.colorWithRGBHex(0x0BD318, alpha: 1.0)
let kYellowColor = UIColor.colorWithRGBHex(0xFFCC00, alpha: 1.0)
let kGrayColor = UIColor.colorWithRGBHex(0xB898C90, alpha: 1.0)
